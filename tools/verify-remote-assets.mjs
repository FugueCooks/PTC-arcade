...
const manifest = [
  ...
  ...JSON.parse(await readFile(path.join(root, 'assets', 'runtime', 'ps2-digests.json'), 'utf8')),
  ...JSON.parse(await readFile(path.join(root, 'assets', 'runtime', 'gamecube-digests.json'), 'utf8'))
];
