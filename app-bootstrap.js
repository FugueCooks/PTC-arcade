...
import { loadGameRegistry } from './games/game-registry.js?v=poke-1';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=poke-1';
...
await import('./arcade.js?v=poke-1');
