...
import { loadGameRegistry } from './games/game-registry.js?v=mm-row-1';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=mm-row-1';
...
await import('./arcade.js?v=mm-row-1');
await import('./avatar-selection.js?v=triple-t-label-2');
await import('./multiplayer-client.js?v=mm-row-1');
