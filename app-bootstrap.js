...
import { loadGameRegistry } from './games/game-registry.js?v=tourney-1';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=tourney-1';
...
await import('./arcade.js?v=tourney-1');
