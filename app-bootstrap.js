...
import { loadGameRegistry } from './games/game-registry.js?v=murals-2';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=murals-2';
...
await import('./arcade.js?v=murals-2');
