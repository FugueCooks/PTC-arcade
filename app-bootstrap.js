...
import { loadGameRegistry } from './games/game-registry.js?v=mobile-scale-1';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=mobile-scale-1';
...
await import('./arcade.js?v=mobile-scale-1');
