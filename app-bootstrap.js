...
import { loadGameRegistry } from './games/game-registry.js?v=floorplan-1';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=floorplan-1';
...
await import('./arcade.js?v=floorplan-1');
