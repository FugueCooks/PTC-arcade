...
import { loadGameRegistry } from './games/game-registry.js?v=poke-4';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=poke-4';
...
await import('./arcade.js?v=poke-4');
