...
import { loadGameRegistry } from './games/game-registry.js?v=chao-1';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=chao-1';
...
await import('./arcade.js?v=chao-1');
