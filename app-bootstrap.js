...
import { loadGameRegistry } from './games/game-registry.js?v=tunnel-2';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=tunnel-2';
...
await import('./arcade.js?v=tunnel-2');
