...
import { loadGameRegistry } from './games/game-registry.js?v=dome-3';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=dome-3';
...
await import('./arcade.js?v=dome-3');
