...
import { loadGameRegistry } from './games/game-registry.js?v=ringplan-2';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=ringplan-2';
...
await import('./arcade.js?v=ringplan-2');
