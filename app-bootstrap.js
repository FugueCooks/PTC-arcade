...
import { loadGameRegistry } from './games/game-registry.js?v=foyer-1';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=foyer-1';
...
await import('./arcade.js?v=foyer-1');
