...
import { loadGameRegistry } from './games/game-registry.js?v=poke-2';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=poke-2';
...
await import('./arcade.js?v=poke-2');
