...
import { loadGameRegistry } from './games/game-registry.js?v=garden-2';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=garden-2';
...
await import('./arcade.js?v=garden-2');
