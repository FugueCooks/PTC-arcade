...
import { loadGameRegistry } from './games/game-registry.js?v=poke-mats-3';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=poke-mats-3';
...
await import('./arcade.js?v=poke-mats-3');
await import('./avatar-selection.js?v=triple-t-label-2');
await import('./multiplayer-client.js?v=poke-mats-3');
