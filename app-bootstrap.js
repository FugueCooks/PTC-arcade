...
import { loadGameRegistry } from './games/game-registry.js?v=hill-2';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=hill-2';
...
await import('./arcade.js?v=solana-neon-1');
