...
import { loadGameRegistry } from './games/game-registry.js?v=tunnel-3';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=tunnel-3';
...
await import('./arcade.js?v=tunnel-3');
