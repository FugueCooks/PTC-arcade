...
import { loadGameRegistry } from './games/game-registry.js?v=rooms-2';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=rooms-2';
...
await import('./arcade.js?v=rooms-2');
