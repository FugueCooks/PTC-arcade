...
import { loadGameRegistry } from './games/game-registry.js?v=big-1';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=big-1';
...
await import('./arcade.js?v=big-1');
