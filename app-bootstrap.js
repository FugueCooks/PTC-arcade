...
import { loadGameRegistry } from './games/game-registry.js?v=murals-4';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=murals-4';
...
await import('./arcade.js?v=murals-4');
