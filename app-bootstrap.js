...
import { loadGameRegistry } from './games/game-registry.js?v=tunnel-1';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=tunnel-1';
...
await import('./arcade.js?v=tunnel-1');
