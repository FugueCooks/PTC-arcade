...
import { loadGameRegistry } from './games/game-registry.js?v=stadium-1';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=stadium-1';
...
await import('./arcade.js?v=stadium-1');
