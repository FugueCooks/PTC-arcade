...
import { loadGameRegistry } from './games/game-registry.js?v=ringplan-1';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=ringplan-1';
...
await import('./arcade.js?v=ringplan-1');
