...
import { loadGameRegistry } from './games/game-registry.js?v=hall-walls-1';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=hall-walls-1';
...
await import('./arcade.js?v=hall-walls-1');
await import('./avatar-selection.js?v=triple-t-label-2');
await import('./multiplayer-client.js?v=hall-walls-1');
