...
import { loadGameRegistry } from './games/game-registry.js?v=east-1';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=east-1';
...
await import('./arcade.js?v=east-1');
