...
import { loadGameRegistry } from './games/game-registry.js?v=murals-1';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=murals-1';
...
await import('./arcade.js?v=murals-1');
