...
import { loadGameRegistry } from './games/game-registry.js?v=no-specks-1';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=no-specks-1';
...
await import('./arcade.js?v=no-specks-1');
await import('./avatar-selection.js?v=triple-t-label-2');
await import('./multiplayer-client.js?v=no-specks-1');
