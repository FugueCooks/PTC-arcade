...
import { loadGameRegistry } from './games/game-registry.js?v=poke-3';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=poke-3';
...
await import('./arcade.js?v=poke-3');
