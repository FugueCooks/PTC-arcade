...
import { loadGameRegistry } from './games/game-registry.js?v=hill-1';
...
import { createDefaultAdapterRegistry } from './emulators/emulator-adapter-registry.js?v=hill-1';
...
await import('./arcade.js?v=hill-1');
