...
const CORES = Object.freeze({ psx: 'psx', n64: 'n64', snes: 'snes9x', gb: 'gambatte', gbc: 'gambatte', gba: 'mgba', nds: 'melonds', nes: 'fceumm', genesis: 'segaMD' });
...
export function createEmulatorJsAdapter({ runtime } = {}) {
  return {
    id: 'emulatorjs',
    supportedPlatforms: Object.freeze(['psx', 'n64', 'snes', 'gb', 'gbc', 'gba', 'nds', 'nes', 'genesis']),
